                        ...
                        <form action="{{ route('store') }}" method="POST" enctype="">
                            ...
                            <div class="m-3">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="umur" id="umur" class="form-control" value="{{ old('umur',$last->umur) }}" required>
                                    @error('umur')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="populasi" id="populasi" class="form-control" value="{{ old('populasi', $last->populasi-($last->mati + $last->afkir)) }}" required>
                                    @error('populasi')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="mati" id="mati" class="form-control" value="{{ old('mati') }}" required>
                                    @error('mati')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="afkir" id="afkir" class="form-control" value="{{ old('afkir') }}" required>
                                    @error('afkir')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="pakan" id="pakan" class="form-control" value="{{ old('pakan') }}" required>
                                    @error('pakan')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="produksi" id="produksi" class="form-control" value="{{ old('produksi') }}" required>
                                    @error('produksi')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="butir" id="butir" class="form-control" value="{{ old('butir') }}" required>
                                    @error('butir')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="retakKg" id="retakKg" class="form-control" value="{{ old('retakKg') }}" required>
                                    @error('retakKg')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
